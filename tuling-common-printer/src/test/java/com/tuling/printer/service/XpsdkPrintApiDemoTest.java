...
import com.tuling.printer.vo.PrintRequest;
import com.tuling.printer.util.PrinterConfig;
import com.tuling.printer.util.NoteFormatter;
import com.tuling.printer.vo.ObjectRestResponse;
...
public class XpsdkPrintApiDemoTest {
    ...
    public void printFontAlign() {
        ...
        //*必填*：打印机编号
        request.setSn(PrinterConfig.OK_PRINTER_SN);
        //*必填*：打印内容,不能超过12K
    ...
    public void printComplexReceipt() throws Exception {
        ...
        printContent.append("菜名").append(StrUtil.repeat(" ", 32))
                .append("数量").append(StrUtil.repeat(" ", 2))
                .append("单价").append(StrUtil.repeat(" ", 2))
                .append("<BR>");
        printContent.append(StrUtil.repeat("-", 48)).append("<BR>");
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("可乐鸡翅", 2, 9.99));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("水煮鱼特辣水煮鱼特辣水煮鱼特辣", 1, 108.0));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭", 1, 99.9));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("炭烤鳕鱼", 5, 19.99));
        printContent.append(StrUtil.repeat("-", 48)).append("<BR>");
        ...
        printContent.append("<C>")
                .append("<QR>https://www.xpyun.net</QR>")
                .append("</C>");
    ...
    public void printComplexReceiptVoiceSupport() throws Exception {
        ...
        printContent.append("菜名").append(StrUtil.repeat(" ", 16))
                .append("数量").append(StrUtil.repeat(" ", 2))
                .append("单价").append(StrUtil.repeat(" ", 2))
                .append("<BR>");
        printContent.append(StrUtil.repeat("-", 32)).append("<BR>");
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("可乐鸡翅", 2, 9.99));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("水煮鱼特辣", 1, 108.0));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("豪华版超级无敌龙虾炒饭", 1, 99.9));
        printContent.append(NoteFormatter.formatPrintOrderItemForNewLine80("炭烤鳕鱼", 5, 19.99));
        printContent.append(StrUtil.repeat("-", 32)).append("<BR>");
        printContent.append("<R>").append("合计：").append("327.83").append("元").append("<BR></R>");
    ...
    public void printLabel() {
        ...
        printContent.append("<PAGE>")
                ...
                .append("#001").append(StrUtil.repeat(" ", 4))
                .append("一号桌").append(StrUtil.repeat(" ", 4))
                .append("1/3")
                .append("</TEXT>")
                ...
                .append("王女士").append(StrUtil.repeat(" ", 4))
                .append("136****3388")
                .append("</TEXT>")
                .append("</PAGE>");
        //第二个标签
